...
<%
    ...
    int r = Integer.parseInt(request.getAttribute("r").toString());
...
<head>
    ...
    <style>
        ...
        .back-button {
            ...
            background: linear-gradient(135deg, #FF6961 0%, #e55a54 100%);
            color: white;
        ...
        .back-button:hover {
            background: linear-gradient(135deg, #e55a54 0%, #d14f49 100%);
            transform: translateY(-2px);
            box-shadow: 0 4px 12px rgba(255, 105, 97, 0.3);
        }
    </style>
</head>
<body>

...
import com.wwwyssa.lab6.client.util.ElementValidator;
import com.wwwyssa.lab6.client.util.FileConsole;
    ...
    private static ExecutionResponse runScript(String fileName) {
        try {
            ...
            try  {
                ...
                return new ExecutionResponse(false,new AnswerString( "Произошла ошибка при выполнении команды скрипта!"));
            }
